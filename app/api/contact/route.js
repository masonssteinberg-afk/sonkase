  ...
  try {
    ...
    await resend.emails.send({
      ...
      html: `<div style="font-family:Georgia,serif;max-width:560px;margin:0 auto;background:#f5f0e8;padding:0;">` +
        ...
        `<div style="font-size:11px;color:#E8C97E;letter-spacing:0.3em;text-transform:uppercase;margin-bottom:4px;">Sonkase™ · Inquiry</div>` +
        ...
        `<p style="font-size:10px;color:rgba(245,240,232,0.3);letter-spacing:0.2em;margin:0;">sonkase.com</p>` +
        `</div></div>`,
    });
